    ...
    const renderSVGMaze = useCallback(() => {
        ...
        return (
            <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`}>
                ...
                <rect x={startX * cellSize} y={0} width={cellSize} height={cellSize / 4} fill="green" />
                <rect x={endX * cellSize} y={height - cellSize / 4} width={cellSize} height={cellSize / 4} fill="red" />
            </svg>
        );
